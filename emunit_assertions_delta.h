...
/**
 * @def UT_ASSERT_DELTA_MSG(d, e, a, ...)
 * @brief Default integer with delta assertion with message
 *
 * This macro maps directly to @ref UT_ASSERT_DELTA_INT_MSG
 *
 * @param[in] d   Delta
 * @param[in] e   Expected value
 * @param[in] a   Actual value
 ...
 */
/**
 * @def UT_ASSERT_DELTA_INT_MSG(d, e, a, ...)
 * @brief Default signed integer with delta assertion with message
 *
 * Macro that checks signed integer value with maximum allowed size.
 *
 * @sa EMUNIT_CONF_NUMBER_SIZE
 ...
 */
/**
 * @def UT_ASSERT_DELTA_UINT_MSG(d, e, a, ...)
 * @brief Default unsigned integer with delta assertion with message
 *
 * Macro that checks unsigned integer value with maximum allowed size.
 *
 * @sa EMUNIT_CONF_NUMBER_SIZE
 ...
 */
/**
 * @def UT_ASSERT_DELTA_HEX_MSG(d, e, a, ...)
 * @brief Default unsigned integer assertion with delta, message version - hexadecimal display
 *
 * @copydetails UT_ASSERT_DELTA_UINT_MSG
 */
...
/**
 * @def UT_ASSERT_DELTA_INT8_MSG(d, e, a, ...)
 * @brief Signed 8-bit assertion with delta, version with message
 *
 * Checks if actual value is between expected +/- delta.
 *
 * @param[in] d Delta
 ...
 */
/**
 * @def UT_ASSERT_DELTA_INT16_MSG(d, e, a, ...)
 * @brief Signed 16-bit assertion with delta, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT8_MSG
 */
/**
 * @def UT_ASSERT_DELTA_INT32_MSG(d, e, a, ...)
 * @brief Signed 32-bit assertion with delta, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT8_MSG
 *
 *  @note This assertion may be disabled.
 ...
 */
/**
 * @def UT_ASSERT_DELTA_INT64_MSG(d, e, a, ...)
 * @brief Signed 64-bit assertion with delta, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT32_MSG
 */

/**
 * @def UT_ASSERT_DELTA_UINT8_MSG(d, e, a, ...)
 * @brief Unsigned 8-bit assertion with delta, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT8_MSG
 */
/**
 * @def UT_ASSERT_DELTA_UINT16_MSG(d, e, a, ...)
 * @brief Unsigned 16-bit assertion with delta, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT16_MSG
 */
/**
 * @def UT_ASSERT_DELTA_UINT32_MSG(d, e, a, ...)
 * @brief Unsigned 32-bit assertion with delta, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT32_MSG
 */
/**
 * @def UT_ASSERT_DELTA_UINT64_MSG(d, e, a, ...)
 * @brief Unsigned 64-bit assertion with delta, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT64_MSG
 */

/**
 * @def UT_ASSERT_DELTA_HEX8_MSG(d, e, a, ...)
 * @brief Unsigned 8-bit assertion with delta - hexadecimal display, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT8_MSG
 */
/**
 * @def UT_ASSERT_DELTA_HEX16_MSG(d, e, a, ...)
 * @brief Unsigned 16-bit assertion with delta - hexadecimal display, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT16_MSG
 */
/**
 * @def UT_ASSERT_DELTA_HEX32_MSG(d, e, a, ...)
 * @brief Unsigned 32-bit assertion with delta - hexadecimal display, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT32_MSG
 */
/**
 * @def UT_ASSERT_DELTA_HEX64_MSG(d, e, a, ...)
 * @brief Unsigned 64-bit assertion with delta - hexadecimal display, version with message
 *
 * @copydetails UT_ASSERT_DELTA_INT64_MSG
 */
